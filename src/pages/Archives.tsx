...
import { FolderClosed, Pencil, Eye, Archive, Plus } from "lucide-react";
...
{/* 
        <Button onClick={addFolder} className="bg-blue-600 text-white px-4 py-2 rounded-lg flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
        {folders.map((id) => (
          <ContextMenu key={id}>
            <ContextMenuTrigger>
              <Button className="flex flex-col items-start bg-white border border-gray-300 rounded-xl p-5 shadow-sm transition-all duration-200 hover:shadow-md hover:bg-gray-100 w-full min-h-[120px]">
