  ...
  return (
    <div className="p-6">
      ...
      <Breadcrumb className="mb-4 text-gray-600 flex space-x-2">
        ...
        <BreadcrumbItem>
          <BreadcrumbLink href="#">Certificate of Extraction</BreadcrumbLink>
        </BreadcrumbItem>
      </Breadcrumb>

      <h1 className="text-2xl font-medium font-poppins mb-6 text-blue-900">
        Certificate of Extractions
      </h1>
          ...
          <ContextMenu key={id}>
            <ContextMenuTrigger>
              <Button
                ...
                onClick={() => navigate(`/folder/${id}`, { state: { from: '/certifications', fromName: 'Certifications' } })}
              >
